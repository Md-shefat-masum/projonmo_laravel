        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Edit translator</div>
                            <hr />
                            <form method="POST" class="update_form" action="{{ route('translator.update',$translator->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{ $translator->name }}" class="form-control" id="input-21" placeholder="Name" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control" id="mytextarea1" cols="30" rows="10">{!! $translator->description !!}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img src="/{{ $translator->image }}" style="height: 40px;" alt="">
