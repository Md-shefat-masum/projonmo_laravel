    ...
    <div class="card position-relative">
        ...
        <div class="card-footer p-1">
            <ul class="d-flex flex-wrap justify-content-center">
                <li><a href="{{ route('product.edit',$product->id) }}" class="btn btn-sm btn-success m-1">Edit</a></li>
                <li><a href="{{ route('product.show',$product->id) }}" class="btn btn-sm btn-warning m-1">View</a></li>
                <li><a href="{{ route('product.destroy',$product->id) }}" data-parent=".admin_product_individual_body" class="btn delete_btn btn-sm btn-danger m-1">Delete</a></li>
            </ul>
        </div>
    </div>
</div>
