                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="filter_nav d-flex flex-wrap">
                                <li><a href="{{ route('admin_blog_create_category') }}" class="custom_white_btn">Create Category</a></li>
                        ...
                        <div class="card-body dragable_list">
                            <ul class='sTree2 listsClass' id='sTree2' style="padding: 20px;">
                                            ...
                                            echo "<div>
                                                    ...
                                                    <div class='clickable action_menu'>
                                                        ...
                                                        <div class='clickable'>
                                                            ...
                                                            <a href='#' class='clickable'>blogs</a>
                                                            <a href='/admin/blog/edit-category/$id/$category_name' class='clickable'>edit</a>
                                                        </div>
                                                    </div>
                                                </div>";
