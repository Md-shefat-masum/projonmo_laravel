...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container" >
            @include('admin.includes.bread_cumb',['title'=>'Create a Category'])
            <div class="row">
                    ...
                    <form action="#" id="form_body" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-header d-inline-flex justify-content-md-between">
                                ...
                                <a href="{{ route('admin_blog_categories') }}" class="btn btn-warning mt-sm-3 mt-md-0" type="button">
                            ...
                            <div class="card-body">
                                ...
                                <div class="from-group row mb-4 d-none">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a href="{{ route('admin_blog_categories') }}" class="btn btn-warning mr-3" type="button">
                                    <i class="fa fa-angle-left"></i> Back
                                </a>
