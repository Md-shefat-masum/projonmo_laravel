...
@section('content')
    @push('css')
        ...
        {{-- <link rel="stylesheet" href="/contents/website/css/pagination.css"> --}}
    @endpush
            ...
            <div class="row">
                <div class="col-12">
                    <pagination
                            ...
                            :limit="4"
                            :align="'center'"
                            @pagination-change-page="get_paginate_product">
                    </pagination>
                    {{-- <div id="demo"></div> --}}
                </div>
            </div>
    ...
    @push('js_plugin')
        ...
        {{-- <script src="/contents/website/js/paginate.js"></script> --}}
    @endpush
