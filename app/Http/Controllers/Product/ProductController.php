...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $translators = Translator::where('status', 1)->get();
    ...
    public function store(Request $request)
    {
        ...
        $product->search_name = $request->search_name;
        ...
        if ($request->has('translator_id')) {
            $product->translator()->attach($request->translator_id);
        }
    ...
    public function edit(Product $product)
    {
        ...
        $categories = Category::where('status', 1)->where('main_category_id', $latest_maincategory_id)->latest()->get();
        $latest_category_id = Category::where('status', 1)->where('main_category_id', $latest_maincategory_id)->exists() ?
            Category::where('status', 1)->where('main_category_id', $latest_maincategory_id)->first()->id : '';
    ...
    public function update(Request $request, Product $product)
    {
        ...
        if ($request->has('translator_id')) {
            $product->translator()->sync($request->translator_id);
        }
